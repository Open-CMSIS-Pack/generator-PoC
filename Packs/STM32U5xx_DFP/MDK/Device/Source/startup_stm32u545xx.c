/******************************************************************************
 * @file     startup_stm32u545xx.c
 * @brief    CMSIS-Core Device Startup File for STM32U545xx Device
 * @version  V1.0.0
...
extern const VECTOR_TABLE_Type __VECTOR_TABLE[];
  ...
  COMP_IRQHandler,                          /*     COMP1 through EXTI Lines interrupt */
  USB_IRQHandler,                           /*     USB global interrupt */
