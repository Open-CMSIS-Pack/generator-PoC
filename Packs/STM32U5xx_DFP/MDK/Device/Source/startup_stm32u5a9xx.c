/******************************************************************************
 * @file     startup_stm32u5a9xx.c
 * @brief    CMSIS-Core Device Startup File for STM32U5A9xx Device
 * @version  V1.0.0
...
void DCACHE2_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler")));
...
extern const VECTOR_TABLE_Type __VECTOR_TABLE[];
  ...
  ADC1_2_IRQHandler,                        /*     ADC1, ADC2 global interrupt */
  ...
  LSECSSD_IRQHandler,                       /*     LSECSSD global interrupt */
  USART6_IRQHandler,                        /*     USART6 global interrupt */
  I2C5_ER_IRQHandler,                       /*     I2C5 error interrupt */
  I2C5_EV_IRQHandler,                       /*     I2C5 event interrupt */
  I2C6_ER_IRQHandler,                       /*     I2C6 error interrupt */
  I2C6_EV_IRQHandler,                       /*     I2C6 event interrupt */
  HSPI1_IRQHandler,                         /*     HSPI1 global interrupt */
  GPU2D_IRQHandler,                         /*     GPU2D global interrupt */
  GPU2D_ER_IRQHandler,                      /*     GPU2D error interrupt */
  GFXMMU_IRQHandler,                        /*     GFXMMU global interrupt */
  LTDC_IRQHandler,                          /*     LCD-TFT global interrupt */
  LTDC_ER_IRQHandler,                       /*     LCD-TFT error interrupt */
  DSI_IRQHandler,                           /*     DSIHOST global interrupt */
  DCACHE2_IRQHandler                        /*     GPU2D Data cache global interrupt */
};
