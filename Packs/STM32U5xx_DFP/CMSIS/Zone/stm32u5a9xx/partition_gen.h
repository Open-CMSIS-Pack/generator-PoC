 ...
 * @brief    CMSIS-CORE Initial Setup for Secure / Non-Secure Zones for STM32U5A9xx Device
 * @version  V1.1.0
 * @date     27.02.2023
 ******************************************************************************/
/*
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     0x200C0000      /* start address of SAU region 2 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END2       0x201FFFFF      /* end address of SAU region 2 */
